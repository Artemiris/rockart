...
class Petroglyph extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'img_author_en' => 'Авторы анг',
            'img_copyright_en' => 'Правообладатель анг',
            'img_source_en' => 'Источник анг',
            'ds_img_author_en' => 'Авторы анг',
            'ds_img_copyright_en' => 'Правообладатель анг',
            'ds_img_source_en' => 'Источник анг',
            'dr_img_author_en' => 'Авторы анг',
            'dr_img_copyright_en' => 'Правообладатель анг',
            'dr_img_source_en' => 'Источник анг',
            'ov_img_author_en' => 'Авторы анг',
            'ov_img_copyright_en' => 'Правообладатель анг',
            'ov_img_source_en' => 'Источник анг',
            're_img_author_en' => 'Авторы анг',
            're_img_copyright_en' => 'Правообладатель анг',
            're_img_source_en' => 'Источник анг',
            'img_author' => 'Авторы',
            'img_copyright' => 'Правообладатель',
            'img_source' => 'Источник',
            'ds_img_author' => 'Авторы',
            'ds_img_copyright' => 'Правообладатель',
            'ds_img_source' => 'Источник',
            'dr_img_author' => 'Авторы',
            'dr_img_copyright' => 'Правообладатель',
            'dr_img_source' => 'Источник',
            'ov_img_author' => 'Авторы',
            'ov_img_copyright' => 'Правообладатель',
            'ov_img_source' => 'Источник',
            're_img_author' => 'Авторы',
            're_img_copyright' => 'Правообладатель',
            're_img_source' => 'Источник',
        ];
    }
